...
clang -o RefalABEinshteinPuzzle_gui.exe RefalABEinshteinPuzzle_gui.o RefalABEinshteinPuzzlec_gui.o Solver.o %REFALABLIB%\mainrf.o -L%REFALABLIB% -lRefalAB gui.o %RAYLIBLFLAGS% >> RefalABEinshteinPuzzle_gui.log
